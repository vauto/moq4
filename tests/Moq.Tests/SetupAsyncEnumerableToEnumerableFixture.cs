...
namespace Moq.Tests
{
	public class SetupAsyncEnumerableToEnumerableFixture
	{
		...
		public void AsyncEnumerableReturnsAsync_on_NoParametersRefReturnType()
		{
			...
			mock.Setup(x => x.NoParametersRefReturnType().ToEnumerable()).Returns(new[] { "TestString" });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.NoParametersValueReturnType().ToEnumerable()).Returns(new[] { 36 });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterRefReturnType("Param1").ToEnumerable()).Returns(new[] { "TestString" });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterValueReturnType("Param1").ToEnumerable()).Returns(new[] { 36 });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ValueParameterRefReturnType(36).ToEnumerable()).Returns(new[] { "TestString" });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ValueParameterValueReturnType(36).ToEnumerable()).Returns(new[] { 37 });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.NewGuidAsync().ToEnumerable()).Returns(() => new[] { Guid.NewGuid() });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ValueParameterRefReturnType(36).ToEnumerable()).Returns(() => new[] { new string(new[] { 'M', 'o', 'q', '4' }) });
		...
		public void AsyncEnumerableThrowsAsync_on_NoParametersRefReturnType()
		{
			...
			mock.Setup(x => x.NoParametersRefReturnType().ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableThrowsAsync_on_NoParametersValueReturnType()
		{
			var mock = new Mock<IAsyncInterface>();
			var exception = new InvalidOperationException();
			mock.Setup(x => x.NoParametersValueReturnType().ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableThrowsAsync_on_RefParameterRefReturnType()
		{
			var mock = new Mock<IAsyncInterface>();
			var exception = new InvalidOperationException();
			mock.Setup(x => x.RefParameterRefReturnType("Param1").ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableThrowsAsync_on_RefParameterValueReturnType()
		{
			var mock = new Mock<IAsyncInterface>();
			var exception = new InvalidOperationException();
			mock.Setup(x => x.RefParameterValueReturnType("Param1").ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableThrowsAsync_on_ValueParameterRefReturnType()
		{
			var mock = new Mock<IAsyncInterface>();
			var exception = new InvalidOperationException();
			mock.Setup(x => x.ValueParameterRefReturnType(36).ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableThrowsAsync_on_ValueParameterValueReturnType()
		{
			var mock = new Mock<IAsyncInterface>();
			var exception = new InvalidOperationException();
			mock.Setup(x => x.ValueParameterValueReturnType(36).ToEnumerable()).Throws(exception);
		...
		public void AsyncEnumerableReturnsAsyncWithDelayDoesNotImmediatelyComplete()
		{
			...
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterValueReturnType("test").ToEnumerable()).Returns(new[] { 5 }, longEnoughForAnyBuildServer);
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterValueReturnType("test").ToEnumerable()).Returns(new[] { 5 }, TimeSpan.FromMilliseconds(1));
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterValueReturnType("test").ToEnumerable()).Returns(new[] { 5 }, TimeSpan.FromMilliseconds(1), TimeSpan.FromMilliseconds(2));
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.RefParameterValueReturnType("test").ToEnumerable()).Returns(new[] { 5 }, TimeSpan.FromMilliseconds(1), TimeSpan.FromMilliseconds(2), new Random());
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(m => m.NoParametersObjectReturnType().ToEnumerable()).Returns((IEnumerable<object>) null);
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(m => m.OneParameterObjectReturnType("").ToEnumerable()).Returns((IEnumerable<object>) null);
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(m => m.ManyParametersObjectReturnType("", false, 0f).ToEnumerable()).Returns((IEnumerable<object>) null);
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ValueParameterValueReturnType(It.IsAny<int>()).ToEnumerable()).Returns((int x) => new[] { x * x });
		...
		public void AsyncEnumerableReturnsAsync_onSingleParameter_LazyEvaluationOfTheResult()
		{
			int coefficient = 5;
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ValueParameterValueReturnType(It.IsAny<int>()).ToEnumerable()).Returns((int x) => new[] { x * coefficient });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ManyParametersObjectReturnType(It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<float>()).ToEnumerable()).Returns((string first, bool second, float third) => new[] { first + third.ToString("N0") });
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ParamsAsync(It.IsAny<DateTime[]>()).ToEnumerable())
				.Returns((DateTime[] dateTimes) => dateTimes);
		...
		public void AsyncEnumerableReturnsAsync_onParams_LazyEvaluationOfTheResult()
		{
			...
			var mock = new Mock<IAsyncInterface>();
			mock.Setup(x => x.ParamsAsync(It.IsAny<DateTime[]>()).ToEnumerable())
				.Returns((DateTime[] dateTimes) => dateTimes.Concat(new[] { comparedDateTime }));
		...
		public async Task PerformSequenceAsyncEnumerableAsync()
		{
			...
			mock.SetupSequence(x => x.NoParametersValueReturnType().ToEnumerable())
				.Returns(new[] { 2 })
				.Returns(() => new[] { 3 })
		...
		{
			var mock = new Mock<IAsyncInterface>();
			mock.SetupSequence(m => m.NoParametersValueReturnType().ToEnumerable())
				.Returns(() => new[] { 1 })
				.Returns(() => new[] { 2 });
